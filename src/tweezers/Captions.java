...
// BBOTONS PANELL PRINCIPAL
    ...
    String[] grafXlabel={"x ("+"\u03BC"+"m)","x (um)", "x (um)"};//;position (radius)","posició Y (radis)","posición Y (radios)"};
    String[] grafYlabel={"z ("+"\u03BC"+"m)","z (um)","z (um)"};//{"Z position (radius)","posició Z (radis)","posición Z (radios)"};
    String[] forceFieldXlabel={"x ("+"\u03BC"+"m)","", ""};
    String[] forceFieldYlabel={"z ("+"\u03BC"+"m)","", ""};
    String[] xcurvexlabel={"x ("+"\u03BC"+"m)","x (um)", "x (um)"};
    String[] zcurvexlabel={"z ("+"\u03BC"+"m)","z (um)", "z (um)"};
    //Tabs
    ...
    //String[] tabCatalogPar={"Set-up configuration", "Configuració del muntatge", "Configuración del montaje"};
